 ...
 */
final class Version20210715120534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, title VARCHAR(190) NOT NULL, edition_years INT DEFAULT NULL, pages_number INT NOT NULL, code_isbn VARCHAR(190) DEFAULT NULL, INDEX IDX_CBE5A331F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE borrower (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, lastname VARCHAR(190) NOT NULL, firstname VARCHAR(190) NOT NULL, phone_number VARCHAR(190) NOT NULL, active TINYINT(1) NOT NULL, creation_date DATETIME NOT NULL, modification_date DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_DB904DB4A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE loan (id INT AUTO_INCREMENT NOT NULL, book_id INT DEFAULT NULL, borrower_id INT NOT NULL, loan_date DATETIME NOT NULL, return_date DATETIME DEFAULT NULL, INDEX IDX_C5D30D0316A2B381 (book_id), INDEX IDX_C5D30D0311CE312B (borrower_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
